...
int run_elf_module(struct elf_module *m, int argc, char** argv)
{
    main_func_t fn;
    fn = (void *)(m->entry);
    ...
    functions[30]=read;
    functions[31]=strtol;
    functions[32]=_setjmp;
    functions[33]=abort;
    functions[34]=strtod;
    functions[35]=remove;
    functions[36]=open;
    functions[37]=__errno_location;
    functions[38]=qsort;
    functions[39]=close;
    
    functions[40]=fstat;
    functions[41]=strcpy;
    functions[42]=strerror;
    functions[43]=stpcpy;
    functions[44]=printf;
    functions[45]=exit;
    functions[46]=calloc;
    functions[47]=sprintf;
    functions[48]=strcat;
    functions[49]=longjmp;
    
    functions[50] = fseek;
    functions[51] = ftell;
    functions[55] = atof;
    functions[56] = fprintf;
    functions[57] = floor;
